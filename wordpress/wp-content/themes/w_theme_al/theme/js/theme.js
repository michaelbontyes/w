...
/**
 * Global JavaScript for w_theme_al
 *
 * Includes all JS which is required within all sections of the theme.
 */

window.w_theme_al = window.w_theme_al || {};

(function( window, $, undefined ) {
	'use strict';

	var w_theme_al = window.w_theme_al;
	...
	// Document ready.
	jQuery(function() {
		w_theme_al.skipLinks();
		w_theme_al.mobileNav();
		w_theme_al.loadFitVids();
