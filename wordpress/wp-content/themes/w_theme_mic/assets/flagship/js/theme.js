/**
 * Global JavaScript for w_theme_mic
 *
 * Includes all JS which is required within all sections of the theme.
 */

window.w_theme_mic = window.w_theme_mic || {};

(function( window, $, undefined ) {
	'use strict';

	var w_theme_mic = window.w_theme_mic;
	...
	// Document ready.
	jQuery(function() {
		w_theme_mic.skipLinks();
		w_theme_mic.mobileNav();
		w_theme_mic.loadFitVids();
