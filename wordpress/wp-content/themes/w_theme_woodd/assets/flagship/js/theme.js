/**
 * Global JavaScript for w_theme_woodd
 *
 * Includes all JS which is required within all sections of the theme.
 */

window.w_theme_woodd = window.w_theme_woodd || {};

(function( window, $, undefined ) {
	'use strict';

	var w_theme_woodd = window.w_theme_woodd;

	$.extend( w_theme_woodd, {
	...
	// Document ready.
	jQuery(function() {
		w_theme_woodd.skipLinks();
		w_theme_woodd.mobileNav();
		w_theme_woodd.loadFitVids();
